...
a=int(input("Podaj liczbę, odpowiadającą figurze, której pole chcesz obliczyćs: 1-trójkąt, 2-prostokąt, 3-trapez, 4-koło, 5-romb, 6-równoległobok, 7-deltoid, 8-sześciokąt foremny, 9-trójkąt równoboczny: "))
